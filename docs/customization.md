...
| `extra-instructions-file` | `.github/agentic-sdlc/<stage>.md` | See layer 2. |
...
| Stage | File | Put here |
|---|---|---|
| implement, fix-review | `.github/agentic-sdlc/implement.md` | regression-anchor tests, things never to touch, how to run one test |
| review | `.github/agentic-sdlc/review.md` | the project review checklist (layers, wrappers, authz rules, ground-truth docs) |
| e2e | `.github/agentic-sdlc/e2e.md` | the always-check paths of the app |
...
confirmation posts it (with the `<!-- agentic-sdlc:plan -->` marker) and adds the
