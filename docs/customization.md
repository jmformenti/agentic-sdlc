...
| `extra-instructions-file` | `.github/claude-sdlc/<stage>.md` | See layer 2. |
...
| `branch-prefix` | `claude/issue-` | Branch = prefix + issue number. Also used by review/e2e to find the linked issue. |
...
| Stage | File | Put here |
|---|---|---|
| implement, fix-review | `.github/claude-sdlc/implement.md` | regression-anchor tests, things never to touch, how to run one test |
| review | `.github/claude-sdlc/review.md` | the project review checklist (layers, wrappers, authz rules, ground-truth docs) |
| e2e | `.github/claude-sdlc/e2e.md` | the always-check paths of the app |
...
confirmation posts it (with the `<!-- claude-sdlc:plan -->` marker) and adds the
