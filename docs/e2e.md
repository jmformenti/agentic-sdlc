...
### `e2e-up.sh` (input `up-script`, default `.github/claude-sdlc/e2e-up.sh`)
...
- Must **append `KEY=VALUE` lines** to the file `$CLAUDE_SDLC_E2E_ENV`. They are rendered
...
The tester posts one comment whose first line is `<!-- claude-sdlc:e2e verdict=pass|fail -->`
...
| Input | Default |
|---|---|
| `up-script` | `.github/claude-sdlc/e2e-up.sh` |
| `down-script` | `.github/claude-sdlc/e2e-down.sh` |
| `extra-instructions-file` | `.github/claude-sdlc/e2e.md` |
| `human-reviewer` | `''` |
